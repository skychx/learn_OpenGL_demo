...
int runibl()
{
    ...
    // -------------------------
    Shader pbrShader("../shaders/6.2.2.pbr.vert", "../shaders/6.2.2.pbr.frag");
    Shader equirectangularToCubemapShader("../shaders/6.2.2.cubemap.vert", "../shaders/6.2.2.equirectangular_to_cubemap.frag");
    Shader irradianceShader("../shaders/6.2.2.cubemap.vert", "../shaders/6.2.2.irradiance_convolution.frag");
    Shader prefilterShader("../shaders/6.2.2.cubemap.vert", "../shaders/6.2.2.prefilter.frag");
    Shader brdfShader("../shaders/6.2.2.brdf.vert", "../shaders/6.2.2.brdf.frag");
    Shader backgroundShader("../shaders/6.2.2.background.vert", "../shaders/6.2.2.background.frag");
    ...
    float *data = stbi_loadf("../resources/textures/hdr/Malibu.hdr", &width, &height, &nrComponents, 0);
