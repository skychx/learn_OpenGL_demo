...
int main()
{
    ...
    // -------------------------
    Shader shader("../shaders/5.7.bloom.vert", "../shaders/5.7.bloom.frag");
    Shader shaderLight("../shaders/5.7.bloom.vert", "../shaders/5.7.light_box.frag");
    Shader shaderBlur("../shaders/5.7.blur.vert", "../shaders/5.7.blur.frag");
    Shader shaderBloomFinal("../shaders/5.7.bloom_final.vert", "../shaders/5.7.bloom_final.frag");
    ...
    glDrawBuffers(2, attachments); // 一个附加了两个颜色缓冲的帧缓冲对象
